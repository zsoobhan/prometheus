        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateField(
                        help_text=b"The date visible on the post", null=True, blank=True
                    ),
                ),
                (
                    "status",
                    models.CharField(
                        default=b"DRAFT",
                        help_text=b"The status of the blog article",
                        max_length=b"16",
                        choices=[(b"PUBLISHED", b"Published"), (b"DRAFT", b"Draft")],
                    ),
                ),
